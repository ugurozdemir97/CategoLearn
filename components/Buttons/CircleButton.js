...
export default function CircleButton({ icon, onPress }) {
    ...
    return (
        <TouchableOpacity style={[ styles.underShadow, styles.circleButton, styles.centered, {backgroundColor: colors.accent, borderColor: colors.accentLight} ]} onPress={onPress} >
